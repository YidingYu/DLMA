...
def my_plot(file1, file2, W):
	...
	print('---------------')
	print('agent', np.mean(throughput_agent1[0][462702]))
	print('aloha', np.mean(throughput_agent2[0][462702]))


for i in range(4, 5):
	plt.figure(i)
	my_plot('rewards/agent_len5e5_M20_h6_W6_%d.txt' % i,
		    'rewards/aloha_len5e5_M20_h6_W6_%d.txt' % i, W=2)
plt.show()

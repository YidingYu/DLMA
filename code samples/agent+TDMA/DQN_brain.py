...
class DQN:
	def __init__(self, 
		...
		# # # # # # # build mode
		self.model        = self.build_model() # model: evaluate Q value
		self.target_model = self.build_model() # target_mode: target network



	'''
	Different neural network models can be used. 
	'''
	def build_model(self):
		inputs = Input(shape=(self.state_size, ))
		h1 = Dense(64, activation='relu')(inputs) 
		outputs =  Dense(self.n_actions)(h1)
